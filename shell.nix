...
let
  ...
  f = { mkDerivation, base, bytestring, case-insensitive
      , configurator, containers, directory, exceptions, filepath
      , HandsomeSoup, hspec, hspec-wai, http-types, hxt, iso8601-time
      , MissingH, mtl, multipart, optparse-applicative, random, silently
      , stdenv, stm, tar, temporary, text, time, transformers, unix
